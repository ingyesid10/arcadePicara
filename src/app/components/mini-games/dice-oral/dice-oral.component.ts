...
@Component({
  selector: 'app-dice-oral',
  templateUrl: './dice-oral.component.html',
  styleUrls: ['./dice-oral.component.css']
})
export class DiceOralComponent implements OnInit, OnDestroy {
  ...
  loadCombinations() {
    ...
    this.combinacionesService.getCombinacionesOral(lang as 'es' | 'en').subscribe(data => {
      this.combos = data || {};
    });
  }
